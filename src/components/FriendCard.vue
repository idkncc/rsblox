...
<template>
    <div class="friend-card" ref="btn">
        <div class="friend-image">
            <img class="rounded-md" :src="headshot" :alt="props.friend.display_name" width="90" height="90" />

            <span v-if="props.friendPresence.presence_type === 'Online'" class="bg-blue-600 user-status">
            ...
            <span v-if="props.friendPresence.presence_type === 'InGame'" class="bg-green-600 user-status">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
            ...
            <span v-if="props.friendPresence.presence_type === 'InStudio'" class="bg-yellow-600 user-status">
                <svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path fill-rule="evenodd"
