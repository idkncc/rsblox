    ...
    <a data-sveltekit-reload href="/user?id={friend.info.user_id}">
        <div class="friend-card">
            <div class="friend-image">
                ...
                {#if friend.presence.presence_type === "Online"}
                    <span class="bg-blue-600 user-status">
                        <svg
                            aria-hidden="true"
                ...
                {:else if friend.presence.presence_type === "InGame"}
                    <span class="bg-green-600 user-status">
                        <svg
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
                ...
                {:else if friend.presence.presence_type === "InStudio"}
                    <span class="bg-yellow-600 user-status">
                        <svg
                            aria-hidden="true"
                            xmlns="http://www.w3.org/2000/svg"
                            width="24"
